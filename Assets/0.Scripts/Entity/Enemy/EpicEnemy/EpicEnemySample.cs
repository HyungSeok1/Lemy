...
/// <summary>
/// Cyclops와 코드가 완전히 같음. 
/// 그냥 예시로 에픽몬스터 사망여부 저장가능함을 보여주는 샘플입니다.
/// </summary>

public class EpicEnemySample : Enemy, LoadTargetEntity
{
    ...
    #region LoadTargetEntity 인터페이스 구현

    public EntityGuide myEntityGuide { get; set; }

    public void SetSpawnFlagFalse()
    {
        myEntityGuide.spawnFlag = false;
    }
    #endregion
